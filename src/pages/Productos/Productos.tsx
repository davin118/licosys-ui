...
export default function Productos() {
    ...
    const getEstadoVencimiento = (fecha: string) => {
        const hoy = dayjs();
    ...
    const exportarExcel = () => {
        const datos = productosFiltrados.map((p) => ({
            ...
            Costo: p.costo,
            Stock: p.stock,
            "Fecha Vencimiento": dayjs(p.fechaVencimiento).format("DD/MM/YYYY"),
        ...
        XLSX.writeFile(libro, "productos_pharmasys.xlsx");
    ...
    return (
        <div className="p-8">
                ...
                {[
                    ...
                    >
                        <Card
                            ...
                            style={{ borderRadius: 10, boxShadow: "0 3px 10px rgba(0,0,0,0.05)" }}
                        >
                            <Statistic
            ...
            <div className="flex flex-wrap justify-between mb-6 items-center gap-4">
                <h2 className="text-2xl font-bold text-blue-600">Gestión de Productos</h2>
                ...
                columns={[
                    ...
                    { title: "Stock", dataIndex: "stock" },
                    {
                        ...
                        render: (fecha: string) => {
                            ...
                            return (
                                <div style={{ fontWeight: "bold", color: estado.color }}>
